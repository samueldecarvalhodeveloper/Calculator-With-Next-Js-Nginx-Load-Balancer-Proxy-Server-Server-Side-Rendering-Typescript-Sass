...
describe('Test Class: "LastSessionCalculationResultStore"; Behavior', () => {
  test('Test If Method: "getExpression"; Returns The Last Session Calculation Result From Key Value Database Correctly', () => {
  ...
  test('Test If Method: "updateExpression"; Updates The Calculation Result Expression On Key Value Database Correctly', () => {
    const calculationResult: string =
      CalculatorCharacters.ONE +
      CalculatorCharacters.ADDITION +
      CalculatorCharacters.ONE;
